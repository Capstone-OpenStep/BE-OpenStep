...
public enum SuccessStatus implements BaseCode {
    ...
    ISSUE_SEARCH_BY_KEYWORD_OK(HttpStatus.OK, "ISSUE_3005", "이슈 키워드 검색 결과 리스트를 성공적으로 조회하였습니다."),
    ...
    TASK_PR_URL_UPDATE_OK(HttpStatus.OK,"TASK_4007","테스크 PR URL 업데이트가 완료되었습니다." ),
